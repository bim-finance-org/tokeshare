        ...
        <Body className="bg-white my-auto mx-auto font-sans">
          <Container className="my-8 mx-auto p-6 w-full max-w-[600px]">
            ...
            <Section className="mb-6">
              ...
              <Text className="text-gray-700 text-base mb-4">Your transaction is being processed. Below, you will find a summary of your request along with the necessary details to make the transfer.</Text>
            </Section>
            ...
            <Section className="bg-gray-50 rounded-lg p-6 mb-6 border border-gray-200">
              ...
              <Row>
                ...
                <Column>
                  ...
                  <Text className="font-bold text-gray-800 mb-1">{tokenSymbol} {tokenAmount}</Text>
                  <Text className="font-bold text-gray-800 mb-1">{walletAddress}</Text>
                </Column>
              </Row>
              
              <Text className="text-xs text-gray-500 mt-3">*Note, the rate may vary depending on market conditions.</Text>
            </Section>
            ...
            <Section className="bg-gray-50 rounded-lg p-6 mb-6 border border-gray-200">
              ...
              <Row>
                ...
                <Column>
                  <Text className="font-bold text-gray-800 mb-1">{fiatSymbol} {fiatAmount}</Text>
