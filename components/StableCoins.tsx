...
const StableCoins = ({ onSelect, blockchain }: StableCoinsProps) => {
    ...
    return (
      ...
      >
        <div className="flex items-center gap-3">
          <Icon />
          <span className="text-color4 font-medium">
            {symbol === "USDCE" ? "USDC.e" : symbol}
          </span>
        </div>
  ...
  return (
    <div>
      <h1 className="text-2xl text-color2 font-bold border-b-2 border-color2 pb-2">
        Select a Stablecoin
      </h1>
      <h2 className="text-lg text-color2 font-bold mt-4 mb-2">
