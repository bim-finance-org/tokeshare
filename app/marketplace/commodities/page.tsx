...
const Page = () => {
  return (
    <div>
      <NavBar />
      <div className="px-6 md:px-12 lg:px-32 py-20 bg-color7 h-auto min-h-[20rem] sm:min-h-[22rem] md:min-h-[24rem] lg:min-h-[26rem]">
        <h1 className="text-color6 text-4xl my-10">Invest in Commodities</h1>
        <p className="text-color3 text-2xl text-justify">With Tokeshare, discover a new way to access the commodities market. Through tokenization, we offer you the opportunity to invest in assets like gold, silver, cocoa, or sugarcane in a simple, secure, and management fee-free way.</p>
      </div>
