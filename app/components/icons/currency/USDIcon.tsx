...
const USDIcon = ({ size = 24, className = '' }: USDIconProps) => {
  return (
    <svg height={size} width={size} className={`rounded-full mr-2 ${className}`} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" >
