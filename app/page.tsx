    ...
    <>
      <div className="relative h-screen bg-color1">
        ...
        <div className="absolute inset-0 flex flex-col items-start justify-center px-6 md:px-36 space-y-4">
          <h1 className="text-white text-4xl md:text-6xl pt-48 md:pt-12 w-full md:w-2/3 lg:w-1/2">Let&apos;s redefine access to investment</h1>
          ...
          <Link href="/buildingInProgress">
            <button className="rounded-lg w-48 bg-color4 px-6 py-2 mb-4 text-sm md:text-lg hover:scale-105 transition-transform duration-300">Sign up</button>
          </Link>
        </div>
      </div>
