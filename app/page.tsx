		...
		<>
			<div className='relative h-screen bg-color1'>
				...
				<div className='absolute inset-0 flex flex-col items-start justify-center px-6 md:px-36 space-y-4'>
					<h1 className='text-white text-4xl md:text-6xl pt-4 w-full md:w-2/3 lg:w-1/2'>
						Let&apos;s redefine access to investment
					</h1>
					<p className='text-white text-sm md:text-lg max-w-lg leading-relaxed text-justify'>
						Through Tokeshare, investors from around the world can now enter the
						Latin American market through fractionalized and tokenized
						ownership. With transparency and the efficiency of blockchain, we
						offer a compliant and modern solution to rethink real estate
						investment.
					</p>
					<p className='text-white text-sm md:text-lg'>
						The future of finance lies in tokenization.
					</p>
			...
			<div className='mt-16 bg-color4 p-8'>
				...
				<h4 className='font-bold text-5xl text-center mb-6'>
				...
				{submitted ? (
					...
					<>
						...
						<form className='flex flex-col items-center space-y-6'>
							...
							<button
								className='flex items-center justify-center py-4 px-8 bg-color5 text-color4 rounded-full text-lg font-medium hover:bg-color2 transition disabled:bg-gray-600'
