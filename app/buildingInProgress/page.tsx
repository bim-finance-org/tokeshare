      ...
      <div className="w-full max-w-md  p-6 rounded-lg shadow-lg">
        {submitted ? (
          ...
          <>
            ...
            <Button className="w-full bg-color2 hover:bg-blue-500 transition-all disabled:bg-gray-600" onClick={handleSubscribe} disabled={!email.trim() || !z.string().email().safeParse(email).success || isSubmitting}>
              Notify Me
            </Button>
          </>
        )}
